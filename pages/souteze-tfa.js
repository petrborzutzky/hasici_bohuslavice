  ...
  return <div className="container">
    ...
    <h3 className="text-lg font-bold mb-5">
        <Link href="https://osh-opava.cz/iii-rocnik-poharu-ksh-msk-v-tfa/">
          <span className="text-lg font-bold mb-5 cursor-pointer underline hover:text-red-700">Pohár Krajského sdružení hasičů v MSK v TFA<ExternalLinkIcon className="h-6 w-6 inline -mt-1 ml-1" /></span>
        </Link>
    </h3>
